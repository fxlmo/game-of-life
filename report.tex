...
\end{minipage}
\caption{16x16 operations per nanosecond comparison}
\end{subfigure}
\hfill
...
\end{minipage}
\caption{128x128 operations per nanosecond comparison}
\end{subfigure}
...
\end{tikzpicture}
\end{minipage}
\caption{512x512 operations per nanosecond comparison}
\end{subfigure}
\hfill
